...
class MainWindow():
    def __init__(self):
        ...
        self.__axes: Axes = self.__plotCanvas.figure.add_subplot(111)
        self.__axes.set_xlabel("$\lambda (\AA)$")
    ...
    def __pathSet(self) -> None:
        ...
        if (self.__path is not None) and (self.__objectName is not None):
            ...
            self.__runButton.clicked.connect(self.__lpm.doLinePolExtraction)
